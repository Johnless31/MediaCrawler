...
async def parse_cmd():
    ...
    parser.add_argument('--type', type=str, help='crawler type (search | detail | creator | creator_only)',
                        choices=["search", "detail", "creator", "creator_only"], default=config.CRAWLER_TYPE)
